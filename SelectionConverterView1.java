...
public class SelectionConverterView1 extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch (comboBox.getSelectedIndex()) {
            case 0:
                new CurrencyConverterView1();
                break;
            case 1:
                new MeasureConverterView1();
                break;
        }
    }
